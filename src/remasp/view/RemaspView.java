...
public class RemaspView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonRegisterZureuckstzn = new javax.swing.JButton();
        ...
        jSpinnerTabellenGr = new javax.swing.JSpinner();
        ...
        buttonNeu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/remasp/Files/images/New24.gif"))); // NOI18N
        ...
        buttonOeffnen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/remasp/Files/images/Open24.gif"))); // NOI18N
        ...
        buttonSpeichern.setIcon(new javax.swing.ImageIcon(getClass().getResource("/remasp/Files/images/Save24.gif"))); // NOI18N
        buttonSpeichern.setToolTipText("Speicher aktuelles Dokument");
        ...
        buttonDrucken.setIcon(new javax.swing.ImageIcon(getClass().getResource("/remasp/Files/images/Print24.gif"))); // NOI18N
        ...
        jTextPane.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        jButtonRegisterZureuckstzn.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jButtonRegisterZureuckstzn.setText("Register auf 0 setzen");
        jButtonRegisterZureuckstzn.setToolTipText("Setzt alle Register auf 0.");
        ...
        jButtonEinzelSchritt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/remasp/Files/images/arrow-right-01.png"))); // NOI18N
        ...
        jSpinnerTabellenGr.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jSpinnerTabellenGr.setModel(new javax.swing.SpinnerListModel(new String[] {"Klein", "Mittel", "Groß"}));
        jSpinnerTabellenGr.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                jSpinnerTabellenGrStateChanged(evt);
            }
        });
        ...
        jMenuDatei.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        jMenuItemNeu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.CTRL_MASK));
        jMenuItemNeu.setText("Neu");
        jMenuDatei.add(jMenuItemNeu);

        jMenuItemOeffnen.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O, java.awt.event.InputEvent.CTRL_MASK));
        ...
        jMenuItemDrucken.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.CTRL_MASK));
        ...
        jMenuBearbeiten.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        jMenuItemRueckgaengig.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Z, java.awt.event.InputEvent.CTRL_MASK));
        ...
        jMenuFormat.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jMenuBar1.add(jMenuFormat);

        jMenuHilfe.setText("Hilfe");
        jMenuHilfe.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        jMenuItemEditorHilfe.setText("Editor Bedienung");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(28, 28, 28)
                                .addComponent(jLabelTabellenGroesse)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jSpinnerTabellenGr, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(346, 346, 346))
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jButtonRegisterZureuckstzn)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jSpinnerTabellenGr)
                            .addComponent(jLabelTabellenGroesse, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jSpinnerTabellenGrStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSpinnerTabellenGrStateChanged
        ...
        if (groesse.equals("Klein")) {
            ...
            jTextPane.setFont(new Font(currentFont.getFontName(), currentFont.getStyle(), 16));
        ...
        if (groesse.equals("Mittel")) {
            ...
            //Schriftgröße des Editors ändern
            Font currentFont = jTextPane.getFont();
            jTextPane.setFont(new Font(currentFont.getFontName(), currentFont.getStyle(), 20));
            jTextPane.setText(jTextPane.getText());
        }
        if (groesse.equals("Groß")) {
            ...
            //Schriftgröße des Editors ändern
            Font currentFont = jTextPane.getFont();
            jTextPane.setFont(new Font(currentFont.getFontName(), currentFont.getStyle(), 25));
            jTextPane.setText(jTextPane.getText());
        }
    }//GEN-LAST:event_jSpinnerTabellenGrStateChanged
    ...
    private void jMenuItemRMSteuerungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemRMSteuerungActionPerformed
        ...
        anzeigeText.setText("<html>"
                ...
                + "        Über den Button <strong>\"Starte Programm\"</strong> wird das, sich im Editor befindende, Programm ausgeführt. Die Ausführungsgeschwindigkeit kann im untersten Regler \"Millisekunen pro Befehl\" eingestsellt werden.<br>\n"
                + "        Über den Button <strong>\"Starte Einzelschrittmodus\"</strong> wird der Einzelschrittmodus aktiviert. In diesem Modus wird der aktuelle Befehl nur ausgeführt, falls die Pfeiltaste betätigt wird. <br>\n"
                ...
                + "        dass bei diesem Vorgang die Registerinhalte gelöscht werden, danach sind also alle Register mit 0 initialisiert. Die Anzahl der Register sollte nicht höher als 500 Tausend sein. <br>\n"
                + "</html>");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        anzeigeText.setContentType("text/html");
        anzeigeText.setText("<html>"
                + "<strong>LOAD #k</strong>: Lädt die Konstante k in Register 0. <br>"
                + "<strong>LOAD i</strong>: Lädt den Inhalt von Register i in Register 0.<br>"
                + "<strong>LOAD *i</strong>: Lädt den Inhalt von demjenigen Register in Register 0, auf welches Register i zeigt (indirekte Adressierung).<br>"
                + "<strong>STORE i</strong>: Speichert den Inhalt von Register 0 in Register i.<br>"
                + "<strong>STORE *i</strong>: Speichert den Inhalt von Register 0 in das Register, worauf Register i zeigt (indirekte Adressierung). Register i darf hier nicht auf Register 0 zeigen, ansonsten wird das Programm abgebrochen.<br>"
                + "<strong>GOTO Marke</strong>: Die Befehlszeile, die mit 'Marke:' anfängt, wird als nächstes ausgeführt.<br>"
                + "<strong>JZERO Marke</strong>: Nur falls der Inhalt von Register 0 0 ist, wird zu der Befehlszeile gesprungen, welche mit 'Marke:' anfängt.<br>"
                + "<strong>JNZERO Marke</strong>: Nur falls der Inhalt von Register 0 ungleich 0 ist, wird zu der Befehlszeile gesprungen, welche mit 'Marke:' anfängt.<br>"
                ...
                + "<strong>ADD x</strong>: Addiert zu Register 0 den Wert des Operanden x hinzu.<br>"
                + "<strong>SUB x</strong>: Zieht von Register 0 den Wert des Operanden x ab. Falls das Ergebnis negativ sein sollte, wird Register 0 auf 0 gesetzt.<br>"
                + "<strong>MUL x</strong>: Multipliziert Register 0 mit den Wert des Operanden x.<br>"
                + "<strong>DIV x</strong>: Division: Register 0 wird durch den Wert von x dividiert. Falls der Wert von x 0 sein sollte,"
    ...
    private void jMenuItemEditorHilfeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemEditorHilfeActionPerformed
        ...
        anzeigeText2.setText("<html>"
                ...
                + "Fügt den Inhalt der Zwischenablage in die aktuelle Cursor Position ein. Es kann nur Text eingefügt werden.\n"
                ...
                + "\n"
//                + "<h3> Format-<em>12..24</em><a name=\"Format-Schriftgröße\"></a></h3>\n"
...
//                + "\n"
    ...
    private void jMenuItemWhileBspActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemWhileBspActionPerformed
        this.getjTextPane().setText(
                "//WHILE Schleife : While R1>R2 DO inkrement R3; dekrement R1 OD\n"
                + "//Eingabe: R1, R2\n"
                + "//Erebnis, Ausgabe: R0= Abstand zw. R1 und R2)\n"
                + "\n"
                + "Anfang:             LOAD	1\n"
                + "		SUB	2\n"
                + "		JZERO	SchleifenEnde\n"
    ...
    private javax.swing.JButton jButtonRegisterZureuckstzn;
    ...
    private javax.swing.JSpinner jSpinnerTabellenGr;
    ...
    /**
     * @return the jMenuItemEntfernen
     */
//    public javax.swing.JMenuItem getjMenuItemEntfernen() {
//        return jMenuItemEntfernen;
//    }
    /**
    ...
    /**
     * @return the jButtonRegisterZureuckstzn
     */
    public javax.swing.JButton getjButtonRegisterZureuckstzn() {
        return jButtonRegisterZureuckstzn;
    }
    ...
    /**
     * @return the jSpinnerTabellenGr
     */
    public javax.swing.JSpinner getjSpinnerTabellenGr() {
        return jSpinnerTabellenGr;
    }
}
